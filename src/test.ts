...
const token =
  'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhZG1pbiIsImlhdCI6MTczNDAwMjc5NTM0NSwiZXhwIjoxNzM0ODY2Nzk1MzQ1fQ.a7vNoGh96n_LF5xhidujD0Y6DNvl63dU5owQEEUnYt4';
let ws: WebSocket | null = null;

const displayBlessed = async () => {
  // Create a screen
